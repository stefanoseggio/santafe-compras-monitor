...
export type DocumentKind = 'pliego' | 'circular' | 'llamado' | 'acta_apertura' | 'nomina_oferentes' | 'cuadro_comparativo' | 'informe_comision' | 'preadjudicacion' | 'adjudicacion' | 'orden_provision' | 'documento_provision' | 'planimetria' | 'otros';
...
export declare const DATA_SOURCE_ATTRIBUTION = "Gestiones de Compra - Gobierno de la Provincia de Santa Fe (santafe.gov.ar/gestionesdecompras), CC BY-SA 2.5 AR";
